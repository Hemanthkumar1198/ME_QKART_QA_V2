    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String
                     ...
                     ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='loading MuiBox-root css-0']//h4[text()=' No products found ']"))));
           // wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']//p[1]")));
        //    wait.until(ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.xpath
        //             ("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'"+product+"')]")),
        //          ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='loading MuiBox-root css-0']//h4[text()=' No products found ']"))));
