...
public class QkartSanity {
     ...
     */
    public static Boolean TestCase01(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status;
     ...
     */
    public static Boolean TestCase02(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status;
     ...
     * working correctly
     */
    public static Boolean TestCase05(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status;
     ...
     */
    public static Boolean TestCase06(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status;
    ...
    public static Boolean TestCase07(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status;
    ...
    public static Boolean TestCase08(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status = false;
    ...
    public static Boolean TestCase09(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status = false;
    ...
    public static Boolean TestCase11(WebDriver driver) throws InterruptedException, TimeoutException {
        Boolean status = false;
        logStatus("Start TestCase",
